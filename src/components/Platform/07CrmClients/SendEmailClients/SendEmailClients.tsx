...
import { sendEmailCRMClient } from '../../../../redux/User/userSlice/actions';
// ELEMENTOS DEL COMPONENTE
import { ICrmClient } from "../../../../types/User/crmClient.types";
import styles from './styles.module.css';

interface ModalPresentationClientsProps {
    token: string;
...
function SendEmailClients ({ token, selectedCrmClient, onCloseModal }: ModalPresentationClientsProps) {
