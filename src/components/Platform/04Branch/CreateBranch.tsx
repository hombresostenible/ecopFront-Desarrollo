...
function CreateBranch () {
    ...
    // const { postBranch, getBranches, branchErrors } = useBranches();
    ...
    //         } as IBranch;
    //         await postBranch(branchData, token);
...
{/* 
            ...
            {/* <form onSubmit={handleSubmit(onSubmit)} className={`${styles.form} position-relative`}>
                ...
                <div className="d-flex">
                    <button className={`${styles.buttonSubmit} m-auto border-0 text-decoration-none`} type='submit' >Enviar</button>
                </div>
            </form> */}
        </div>
    )
