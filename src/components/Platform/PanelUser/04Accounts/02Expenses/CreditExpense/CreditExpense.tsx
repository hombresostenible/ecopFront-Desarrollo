...
function CreditExpense({ token, decodeUserIdRegister, selectedBranch, defaultDates, registrationDate, transactionDate }: IncomeCreditProps) {
    ...
    //         dispatch(getAssetsByBranch(branch, token));
    //     }
    //     if (otherExpenses === 'Mercancia') {
    //         dispatch(getMerchandisesByBranch(branch, token));
    //     }
    //     if (otherExpenses === 'Materia Prima') {
    //         dispatch(getRawMaterialsByBranch(branch, token));
    //     }
    //     if (otherExpenses === 'Servicio') {
    //         dispatch(getServicesByBranch(branch, token));
    //     }
    // }, [ otherExpenses, token ]);
