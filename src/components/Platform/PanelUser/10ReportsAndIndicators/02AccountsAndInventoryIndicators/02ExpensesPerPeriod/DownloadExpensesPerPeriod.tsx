...
function DownloadExpensesPerPeriod({ user, date, data, nameBranch }: DownloadExpensesPerPeriodProps) {
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={stylesPDFDownloadIndicator.container__Component}>
                <View style={stylesPDFDownloadIndicator.top}>
                    <View>
                        <Text style={stylesPDFDownloadIndicator.title}>GASTOS DEL PERIODO</Text>
