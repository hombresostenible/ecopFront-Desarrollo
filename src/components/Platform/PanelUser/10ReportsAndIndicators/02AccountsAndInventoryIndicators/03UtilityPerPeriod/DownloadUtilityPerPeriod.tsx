...
function DownloadUtilityPerPeriod({ user, date, data, nameBranch }: DownloadUtilityPerPeriodProps) {
        ...
        <Document>
            <Page size="A4" orientation="landscape" style={stylesPDFDownloadIndicator.container__Component}>
                <View style={stylesPDFDownloadIndicator.top}>
                    <View>
                        <Text style={stylesPDFDownloadIndicator.title}>UTILIDAD DEL PERIODO</Text>
