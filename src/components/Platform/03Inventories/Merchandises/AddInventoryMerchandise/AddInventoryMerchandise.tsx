...
function IncreaseYourInventoryMerchandise({ token, idItem, nameItem, idBranch, onCloseModal }: IncreaseYourInventoryMerchandiseProps) {
...
export default IncreaseYourInventoryMerchandise;