        ...
        <div>
            ...
            <div className={`${styles.container} `}>
                <div className="d-flex flex-column">
                    ...
                    <p className='mb-5'>Así mismo, cuando requieras hacer notas Credito para anular tu factura ya generada, deberás suministrar la información exigida por la DIAN para este propósito y a través de nuestros aliados, haremos todo el proceso de gestión de tu solicitud.</p>
                </div>
            </div>
            <Footer />
        </div>
