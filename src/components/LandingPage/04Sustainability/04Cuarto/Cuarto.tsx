        ...
        <div>
            ...
            <div className={`${styles.container} `}>
                <div className="d-flex flex-column">
                    ...
                    <p className='mb-5'>Para registrar las ventas o compras hemos hecho un gran esfuerzo por solicitar la información mínima que nos permita calcular los indicadores. Cuando tu venta o tu compra es de contado, debes registrar información sobre qué vendiste, cuánto vendiste y a qué precio. Cuando tu venta o tu compra es a crédito, debes registrar unos datos adicionales. </p>
