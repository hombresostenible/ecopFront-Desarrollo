...
function SendEmailResetPasswordCompanyPage() {
            ...
            <div className={styles.containerSendEmail}>
                <div className={` d-flex flex-column align-items-center justify-content-center`}>
                    <div>
                        ...
                        <p className='text-center'>Introduce la dirección de correo que usaste en el registro de tu empresa. Te enviaremos un correo con el link de verificación para que puedas restablecer tu contraseña.</p>
...
export default SendEmailResetPasswordCompanyPage;