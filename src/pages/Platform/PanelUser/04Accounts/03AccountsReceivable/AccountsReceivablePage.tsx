...
import { putAccountsBook, deleteAccountsBook } from '../../../../../redux/User/accountsBookSlice/actions';
...
function AccountsReceivablePage() {
    ...
    const handleFilter = () => {
        ...
        const filtered = Array.isArray(accountsReceivable)
            ? accountsReceivable.filter((accountsBook) => {
    ...
    const transactionsToDisplay = filteredTransactions !== null ? filteredTransactions : accountsReceivable;
                    ...
                    <div className={`${styles.container__Component} overflow-hidden overflow-y-auto`}>
                        ...
                        {Array.isArray(sortedTransactions) && sortedTransactions.length > 0 ? (
                            <div>
                                ...
                                {Array.isArray(accountsReceivable) && accountsReceivable.map((accountsBook) => (
