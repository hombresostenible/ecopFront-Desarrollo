...
import { getAccountsBooksExpenses, putAccountsBook, deleteAccountsBook } from '../../../../../../redux/User/accountsBookSlice/actions';
...
function ConsultExpensesPage() {
    ...
    useEffect(() => {
        if (token) {
            ...
            dispatch(getAccountsBooksExpenses(token));
        }
    }, [token]);
                ...
                <div className={`${styles.container} d-flex flex-column align-items-center justify-content-between overflow-hidden overflow-y-auto`}>
                    <div className={`${styles.container__Component} overflow-hidden overflow-y-auto`}>
                        <div className="custom-container text-center" >
                            <h1 className={`${styles.title} text-center`}>Gastos</h1>
                        </div>
                        <Link to='/accounts/create-expenses'>Crea tus gastos</Link>
...
export default ConsultExpensesPage;