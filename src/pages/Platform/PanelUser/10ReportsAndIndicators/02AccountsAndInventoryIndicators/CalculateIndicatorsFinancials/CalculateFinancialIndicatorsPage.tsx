...
import SalesPerPeriod from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/01SalesPerPeriod/SalesPerPeriod';
import ExpensesPerPeriod from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/02ExpensesPerPeriod/ExpensesPerPeriod';
import UtilityPerPeriod from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/03UtilityPerPeriod/UtilityPerPeriod';
import BestClientValue from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/04BestClientValue/BestClientValue';
import BestClientQuantity from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/05BestClientQuantity/BestClientQuantity';
import AverageTicket from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/06AverageTicket/AverageTicket';
import AccountsPayable from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/07AccountsPayable/AccountsPayable';
import AccountsReceivable from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/08AccountsReceivable/AccountsReceivable';
import InventoryAssets from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/09InventoryAssets/InventoryAssets';
import InventoryMerchandises from '../../../../../../components/Platform/PanelUser/10ReportsAndIndicators/02AccountsAndInventoryIndicators/10InventoryMerchandises/InventoryMerchandises';
